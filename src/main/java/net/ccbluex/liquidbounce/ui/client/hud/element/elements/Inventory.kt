...
class Inventory : Element(300.0, 50.0, 1F, Side(Side.Horizontal.RIGHT, Side.Vertical.UP)) {
    ...
    private val bdRedValue = object : IntegerValue("BDRed", 255, 0, 255) {
		override fun isSupported() = borderValue.get()
	}
    private val bdGreenValue = object : IntegerValue("BDGreen", 255, 0, 255) {
		override fun isSupported() = borderValue.get()
	}
    private val bdBlueValue = object : IntegerValue("BDBlue", 255, 0, 255) {
		override fun isSupported() = borderValue.get()
	}

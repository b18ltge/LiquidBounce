...
public class UltralightGlfwOpenGLContext {
     ...
     */
    public UltralightGlfwOpenGLContext bindTexture(int textureId, UltralightGlfwOpenGLWindow window) {
        this.driver.bindTexture(textureId, window);
        return this;
    }

    public int getTextureId(UltralightGlfwOpenGLWindow window) {
        return this.driver.getTextureId(window);
    }
